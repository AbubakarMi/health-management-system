        ...
        return (
             <div className="flex items-center justify-center h-full">
                <Card className="w-full max-w-md">
                    ...
                    <CardContent>
                        <p>The requested autopsy case could not be found or you do not have permission to view it.</p>
                        <Button asChild className="mt-4">
                            <Link href="/doctor/autopsy">Return to Case List</Link>
                        </Button>
                    </CardContent>
                </Card>
            </div>
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                <Button variant="outline" size="icon" asChild>
                    <Link href="/doctor/autopsy"><ArrowLeft /></Link>
                </Button>
                <div>
