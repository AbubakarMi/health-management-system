...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert AI medical scribe specializing in pathology. Your task is to write a comprehensive and formal autopsy report by expanding on the pathologist's brief clinical findings. The report must be detailed, structured, and use appropriate medical terminology.
...
Example Structure:
"A post-mortem examination was performed on the body of {{deceasedName}} on [Date, if inferable].
