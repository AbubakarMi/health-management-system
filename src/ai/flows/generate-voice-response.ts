...
/**
 * @fileOverview An AI agent for generating voice responses using Text-to-Speech.
 *
 * - generateVoiceResponse - Converts a text string into spoken audio.
 * - GenerateVoiceResponseInput - The input type for the function.
 * - GenerateVoiceResponseOutput - The return type for the function.
 */
