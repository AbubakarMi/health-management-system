...
const detailedPatients = [
        ...
        medicalHistory: [
            {
                date: '2024-05-12',
                event: 'Admission',
                details: 'Admitted for observation after a minor accident.',
                doctor: 'Dr. Evelyn Reed'
            }
        ],
        prescriptions: [],
        labTests: initialLabTests.filter((t)=>t.patient === 'Michael Brown'),
        admission: {
            isAdmitted: true,
            admissionDate: '2024-05-12',
            dischargeDate: null,
    ...
    },
    {
        ...
        prescriptions: [],
        labTests: initialLabTests.filter((t)=>t.patient === 'Emily Davis'),
        admission: {
            isAdmitted: false,
            admissionDate: null,
            dischargeDate: null,
        ...
        medicalHistory: [
            {
                ...
                details: 'Annual physical, all vitals normal.',
                doctor: 'Dr. Evelyn Reed'
            }
        ],
        prescriptions: [],
        labTests: initialLabTests.filter((t)=>t.patient === 'Chris Wilson'),
        admission: {
            isAdmitted: false,
            admissionDate: null,
            dischargeDate: null,
...
class PatientManager {
    ...
    updatePatientCondition(patientId, newCondition, doctorName) {
        ...
        if (patient) {
            ...
            if (doctorName) {
                let event = "Condition Update";
                let details = `Patient condition changed from ${oldCondition} to ${newCondition}.`;
                if (newCondition === 'Deceased') {
                    event = "Patient Deceased";
                    details = "Patient has been marked as deceased.";
...
class LabTestManager {
    ...
    updateLabTest(testId, status, results) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c3c5613._.js.map