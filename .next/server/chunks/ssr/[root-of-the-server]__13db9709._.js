...
__turbopack_context__.s({
    ...
    "mockDoctorAdmissionsData": (()=>mockDoctorAdmissionsData),
    "mockFinancialData": (()=>mockFinancialData),
    "mockLabTests": (()=>mockLabTests),
...
const users = [
    ...
    {
        name: 'Mark Chen',
        email: 'mark.chen@medtrack.pro',
        role: 'pharmacist',
        password: 'password123'
    },
    {
        name: 'Angela Rodriguez',
        email: 'angela.rodriguez@medtrack.pro',
        role: 'finance',
        password: 'password123'
    },
    {
        name: 'Ben Carter',
        email: 'ben.carter@medtrack.pro',
        role: 'lab-tech',
        password: 'password123'
    },
    {
        name: 'Olivia Martinez',
        email: 'olivia.martinez@medtrack.pro',
        role: 'admin',
        password: 'password123'
    }
];
...
const detailedPatients = [
    {
        ...
        medicalHistory: [
            {
                date: '2024-05-10',
                event: 'Check-up',
                details: 'Routine check-up, vitals are normal.',
                doctor: 'Dr. Evelyn Reed'
            },
            {
                date: '2024-03-15',
        ...
        prescriptions: [
            initialPrescriptions[0]
        ],
        labTests: mockLabTests.filter((t)=>t.patient === 'John Doe')
    },
    {
        id: 'p-002',
        name: 'Jane Smith',
        ...
        medicalHistory: [
            {
                ...
                details: 'Admitted for severe chest pain.',
                doctor: 'Dr. Evelyn Reed'
            },
            {
                date: '2023-11-20',
        ...
        prescriptions: [
            initialPrescriptions[1]
        ],
        labTests: mockLabTests.filter((t)=>t.patient === 'Jane Smith')
    },
    {
        id: 'p-003',
        name: 'Bob Johnson',
        ...
        medicalHistory: [
            {
                date: '2024-05-09',
                event: 'Follow-up',
                details: 'Follow-up for bacterial infection. Responding well to antibiotics.',
                doctor: 'Dr. Evelyn Reed'
            }
        ],
        prescriptions: [
            initialPrescriptions[2]
        ],
        labTests: mockLabTests.filter((t)=>t.patient === 'Bob Johnson')
    },
    {
        id: 'p-004',
        name: 'Alice Williams',
        ...
        medicalHistory: [
            {
                date: '2024-05-11',
                event: 'Check-up',
                details: 'Complaining of seasonal allergies.',
                doctor: 'Dr. Evelyn Reed'
            }
        ],
        prescriptions: [
            initialPrescriptions[3]
        ],
        labTests: mockLabTests.filter((t)=>t.patient === 'Alice Williams')
    }
];
const navLinks = {
    admin: [
...
const mockDoctorAdmissionsData = [
    {
        doctor: 'Dr. Smith',
        admissions: 25
    },
...
function LoginPage() {
    ...
    const handleLogin = (e)=>{
        e.preventDefault();
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["users"].find((u)=>u.email.toLowerCase() === email.toLowerCase());
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    children: [
                        ...
                        " MediTrack Pro. All rights reserved."
                    ]
                }, void 0, true, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 68,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13db9709._.js.map