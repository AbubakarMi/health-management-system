...
function UserManagementTable() {
    ...
    const handleSaveUser = (savedUser, originalEmail)=>{
        if (editingUser && originalEmail) {
            ...
            setUsers(users.map((u)=>u.email === originalEmail ? {
                    ...u,
                    ...savedUser
                } : u));
            toast({
...
_s(UserManagementTable, "KLwAOpkXn1wvIAxHAA3zu6W7Jks=", false, function() {
    return [
...
//# sourceMappingURL=src_components_97816bf8._.js.map