...
class PrescriptionManager {
    ...
    addPrescription(prescription) {
        ...
        patient?.medicalHistory.unshift({
            date: new Date().toISOString().split('T')[0],
            event: `Prescription Added: ${newPrescription.medicine}`,
            details: `Dosage: ${newPrescription.dosage}`,
    ...
    addSuggestion(prescriptionId, suggestion, patientId) {
        ...
        if (prescription) {
            ...
            // DO NOT add to medical history here. Only when accepted/rejected.
            this.notify();
            patientManager.notify();
        }
    }
...
//# sourceMappingURL=_66190f37._.js.map